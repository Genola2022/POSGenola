                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('clientes.update', $cliente) }}" method="post">
                            ...
                            <div class="form-group row">
                                <label for="costo" class="col-md-4 col-form-label text-md-right">Teléfono</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="listaprecio_id"
                                        ...
                                        name="listaprecio_id">
                                        <option value="0">Selecciona lista de precios</option>
                                        @foreach ($listaprecios as $item)
                                            <option @if ($cliente->listaprecio_id == $item->id) selected @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input placeholder="Ingresa el limite de credito" id="limitecredito" type="number"
                                        ...
                                        name="limitecredito"
                                        value="{{ old('limitecredito', number_format($cliente->limitecredito, 0, '', '')) }}">
                                    @error('limitecredito')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
